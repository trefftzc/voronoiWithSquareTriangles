...
public class SecondQuadTree
{
    private QuadTreeNode root = null;

    public SecondQuadTree()
    {
    }
	...
	Point p1 = new Point(1,n-1);
        Point p2 = new Point(n-1,n-1);
        Point p3 = new Point(n-1,1);
	...
	int closestSeedTop1 = 0;
	closestSeedTop1 = calcClosestSeed(p1,seeds);
        int closestSeedTop2 = 0;
	closestSeedTop2 = calcClosestSeed(p2,seeds);
	int closestSeedTop3 = 0;
	closestSeedTop3 = calcClosestSeed(p3,seeds);
